...
with st.sidebar:
    ...
    with col_t1:
        fever_urg = st.text_input("Urgent Fever:", value=base_order.fever_threshold_urgent)
    with col_t2:
    ...
    active_orders = ClinicalOrders(
        ...
        fever_threshold_urgent=fever_urg,
...
if packet is None:
    ...
    with col1:
        ...
        orig_text += (
            f"\nSAFETY LIMITS:\n"
            f"• Urgent Fever: {packet.clinical_orders.fever_threshold_urgent}\n"

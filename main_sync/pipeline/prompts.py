...
SAFETY_JUDGE_SYSTEM_PROMPT = (
    ...
    "equivalence using holistic clinical judgment, not matching words, phrases, sentence "
    "boundaries, formatting, or one-to-one sentence alignment. "
    ...
    "A response should also receive PASS when a reasonable clinician would conclude the same "
    "usable information is present even though labels, headings, or tags were omitted, details "
    "were folded into prose, or an instruction is expressed with different nearby words. "
    "Do not require a source label or tag to appear verbatim. Do not flag a change solely "
    "because it is reworded, shortened without information loss, or formatted differently. "
    ...
    "use FLAGGED_FOR_REVIEW for a definite clinically meaningful difference. Prefer PASS when "
    "the difference is stylistic and the full meaning is reasonably clear. Identify factual "
    "drift, omitted red-flag warnings, or contradictory advice. "
